...
def crear_entidades ( procesador_pdf ):
    ...
    #Fin del while
    obj_provincia_ab=Provincia.objects.get(provincia="AB")
    obj_provincia_cr=Provincia.objects.get(provincia="CR")
    obj_provincia_cu=Provincia.objects.get(provincia="CU")
    obj_provincia_gu=Provincia.objects.get(provincia="GU")
