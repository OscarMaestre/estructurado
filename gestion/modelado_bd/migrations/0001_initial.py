# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-03-20 12:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pago', models.CharField(choices=[('Ignorar', 'Ignorar'), ('Efectivo', 'Pagado en efectivo'), ('Transferencia', 'Pagado por transf'), ('No pagado', 'No pagado')], max_length=20)),
            ],
            options={
